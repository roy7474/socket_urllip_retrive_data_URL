...
user_url = input('Please enter the URL of the website to count its parragraphs: ')
try :
    url = user_url
    ...
    print('There was an error while trying to open the URL that you provided. Please try again!')
except ValueError:
    print('There was an error while trying to open the URL that you provided. Please try again!')
